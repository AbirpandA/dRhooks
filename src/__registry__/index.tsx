...
export const Index: Record<string, any> = {
  ...
  accordino: {
    ...
    files: [
      {
        path: "src/registry/new-york/ui/accordino.tsx",
        content:
  ...
  "bounce-button-demo": {
    ...
    component: React.lazy(
      () => import("@/registry/new-york/examples/bounce-button-example.tsx")
    ),
    source:
      'import Bouncebutton from "../ui/bounce-button";\n\nexport default function BouncebuttonDemo() {\n  return <Bouncebutton>CLICK ME</Bouncebutton>;\n}\n',
  },
  "loading-swap-demo": {
    ...
    component: React.lazy(
      () => import("@/registry/new-york/examples/loading-swap-example.tsx")
    ),
    source:
      '"use client";\n\nimport { Button } from "@/components/ui/button";\nimport { LoadingSwap } from "@/registry/new-york/ui/loading-swap";\nimport { useTransition } from "react";\n\nexport default function LoadingButton() {\n  const [isLoading, startTransition] = useTransition();\n\n  return (\n    <Button\n      onClick={() => {\n        startTransition(async () => {\n          // Simulate loading state\n          await new Promise((res) => setTimeout(res, 1000));\n        });\n      }}\n    >\n      <LoadingSwap isLoading={isLoading}>Click Me</LoadingSwap>\n    </Button>\n  );\n}\n',
  },
  "shimmer-text-demo": {
    ...
    component: React.lazy(
      () => import("@/registry/new-york/examples/shimmer-text-example.tsx")
    ),
    source:
      'import React from "react";\nimport { ShimmerText } from "../ui/shimmer-text";\n\nconst ShimmerTextDemo = () => {\n  return (\n    <ShimmerText\n      duration={3}\n      className="tracking-loose text-xl"\n      shimmerWidth={20}\n    >\n      Loading...\n    </ShimmerText>\n  );\n};\n\nexport default ShimmerTextDemo;\n',
  },
  "prompt-input-demo": {
    ...
    component: React.lazy(
      () => import("@/registry/new-york/examples/prompt-input-example.tsx")
    ),
    source:
      'import React from "react";\nimport { PromptInput } from "../ui/prompt-input";\n\nconst PromptInputExample = () => {\n  async function handleSubmit(value: string, files?: File[]) {\n    return new Promise<void>((resolve) => {\n      setTimeout(() => {\n        console.log("Submitted value:", value);\n        if (files) {\n          console.log("With files:", files);\n        }\n        resolve();\n      }, 2000);\n    });\n  }\n\n  function handleError(error: Error) {\n    console.error("Error during submission:", error);\n  }\n\n  return (\n    <div className="">\n      <PromptInput\n        onsubmit={handleSubmit}\n        onError={handleError}\n        allowFiles={true}\n        loading={false}\n        placeholder="Type your prompt here..."\n        maxLength={3000}\n      />\n    </div>\n  );\n};\n\nexport default PromptInputExample;\n',
  },
  "accordino-demo": {
    ...
    files: [
      {
        path: "src/registry/new-york/examples/accordino-example.tsx",
        content:
    ...
    component: React.lazy(
      () => import("@/registry/new-york/examples/accordino-example.tsx")
    ),
    source:
      'import {\n  Accordion,\n  AccordionItem,\n  AccordionTrigger,\n  AccordionContent,\n} from "../ui/accordino";\n\nexport default function AccordinoDemo() {\n  return (\n    <Accordion type="single" collapsible className="w-full max-w-md max-h-md">\n      <AccordionItem value="item-1">\n        <AccordionTrigger>Is it accessible?</AccordionTrigger>\n        <AccordionContent>\n          Yes. It adheres to the WAI-ARIA design pattern.\n        </AccordionContent>\n      </AccordionItem>\n      <AccordionItem value="item-2">\n        <AccordionTrigger>Is it styled?</AccordionTrigger>\n        <AccordionContent>\n          Yes. It comes with default styles that you can customize.\n        </AccordionContent>\n      </AccordionItem>\n    </Accordion>\n  );\n}\n',
  },
  ...
  "use-fetch": {
    name: "use-fetch",
    description:
      "A hook to fetch data from an API endpoint with loading and error states.",
    type: "registry:component",
    files: [
      {
  ...
  "use-debounce-demo": {
    ...
    component: React.lazy(
      () => import("@/registry/new-york/examples/use-debounce-example.tsx")
    ),
    source:
      '"use client";\n\nimport { useState } from "react";\nimport { useDebounce } from "../hooks/use-debounce";\n\nexport default function UseDebounceDemo() {\n  const [q, setQ] = useState("");\n  const { debounced } = useDebounce(q, 500);\n\n  return (\n    <div className="space-y-2">\n      <input\n        className="border px-2 py-1 rounded"\n        value={q}\n        onChange={(e) => setQ(e.target.value)}\n        placeholder="Type to debounce"\n      />\n      <div className="p-2 text-sm">Immediate: {q}</div>\n      <div className="p-2 text-sm">Debounced: {debounced}</div>\n    </div>\n  );\n}\n',
  },
  "use-fetch-demo": {
    ...
    component: React.lazy(
      () => import("@/registry/new-york/examples/use-fetch-example.tsx")
    ),
    source:
      '"use client";\nimport React, { useState } from "react";\nimport { useFetch } from "../hooks/use-fetch"; // Make sure to import your hook\n\n// A simple component to display the post data\nfunction PostDisplay() {\n  const [postId, setPostId] = useState(1);\n\n  // Use your hook. The URL will change whenever \`postId\` changes.\n  const { data, loading, error, refetch } = useFetch<Post>(\n    \`https://jsonplaceholder.typicode.com/posts/\${postId}\`\n  );\n\n  // Handler for manually refetching the *same* post\n  const handleRefetch = () => {\n    console.log("Manual refetch requested...");\n    refetch();\n  };\n\n  // Handlers for changing the URL, which triggers an automatic refetch\n  const getNextPost = () => {\n    setPostId((prevId) => prevId + 1);\n  };\n\n  const getFirstPost = () => {\n    setPostId(1);\n  };\n\n  return (\n    <div style={{ padding: "20px", fontFamily: "sans-serif" }}>\n      <h2>useFetch Example</h2>\n      \n      <div style={{ marginBottom: "15px" }}>\n        <button onClick={getNextPost} disabled={loading}>\n          {loading ? "Loading..." : "Fetch Next Post"}\n        </button>\n        <button onClick={handleRefetch} disabled={loading} style={{ marginLeft: "10px" }}>\n          Refetch Post {postId}\n        </button>\n        <button onClick={getFirstPost} disabled={loading || postId === 1} style={{ marginLeft: "10px" }}>\n          Reset to Post 1\n        </button>\n      </div>\n\n      {/* 1. Loading State */}\n      {loading && <p>Loading data...</p>}\n\n      {/* 2. Error State */}\n      {error && (\n        <p style={{ color: "red" }}>\n          Error fetching data: {error.message}\n        </p>\n      )}\n\n      {/* 3. Data State */}\n      {data && (\n        <article>\n          <h3>{data.title} (Post ID: {data.id})</h3>\n          <p>{data.body}</p>\n        </article>\n      )}\n    </div>\n  );\n}\n\n// Define the type for the data we expect\ninterface Post {\n  userId: number;\n  id: number;\n  title: string;\n  body: string;\n}\n\nexport default PostDisplay;',
  },
