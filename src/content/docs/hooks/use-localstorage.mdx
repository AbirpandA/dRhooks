...
<Tab>
``` sh
npx shadcn@latest add https://dr-hooks.vercel.app/r/use-local-storage.json
````
...
```sh
pnpm dlx shadcn@latest add https://dr-hooks.vercel.app/r/use-local-storage.json
```
...
```sh
yarn dlx shadcn@latest add https://dr-hooks.vercel.app/r/use-local-storage.json
```
